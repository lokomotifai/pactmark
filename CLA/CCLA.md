...
This version of the Agreement allows an entity (the "Corporation") to authorize
Contributions submitted by its designated employees to the Project Steward and
...
- Signatory title: _______________________________________________
...
to submit Contributions to the designated Work on behalf of the Corporation.
...
## 8. Changes to Authorized Contributors

It is your responsibility to notify the Project Steward when any change is
...
Source: [Apache Software Foundation CCLA V2.0](https://svn.apache.org/repos/infra/websites/production/www/content/licenses/proposed/ccla.pdf).
...
4. **Section 2:** replaced the licensee identifier and made the source clause's
   ...
   license; the operative rights otherwise remain the ASF V2.0 rights.
5. **Section 3:** replaced only the licensee identifier; the patent grant and
   termination language otherwise remain the ASF V2.0 language.
