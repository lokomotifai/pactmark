...
store is not production durability. Public release ownership, per-package
provenance, and exact registry bytes are verified for v0.2.0. That state establishes
none of the production or security claims excluded above.
