...
export const POSTGRES_WORK_ORDER_RETENTION_BINDINGS_SCHEMA_SQL = `
...
export const POSTGRES_MIGRATIONS: readonly PostgresMigration[] = Object.freeze([
  ...
  Object.freeze({
    version: "012",
    description: "retention-safe immutable run WorkOrder bindings",
    reversibleSafe: false,
    up: [POSTGRES_WORK_ORDER_RETENTION_BINDINGS_SCHEMA_SQL],
    down: [],
  }),
]);
