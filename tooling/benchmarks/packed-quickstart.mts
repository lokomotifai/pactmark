...
export async function runPackedQuickstartBenchmark(
  ...
  const tarballs = {
    "@pactmark/agent": join(tarballDirectory, "pactmark-agent-0.2.0.tgz"),
    "@pactmark/core": join(tarballDirectory, "pactmark-core-0.2.0.tgz"),
    "@pactmark/evidence": join(tarballDirectory, "pactmark-evidence-0.2.0.tgz"),
    "@pactmark/executor-in-process": join(
      tarballDirectory,
      "pactmark-executor-in-process-0.2.0.tgz",
    ),
    "@pactmark/policy": join(tarballDirectory, "pactmark-policy-0.2.0.tgz"),
    "@pactmark/runtime": join(tarballDirectory, "pactmark-runtime-0.2.0.tgz"),
    "@pactmark/store-memory": join(tarballDirectory, "pactmark-store-memory-0.2.0.tgz"),
  } as const;
